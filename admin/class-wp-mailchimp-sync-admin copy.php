...
class Wp_Mailchimp_Sync_Admin
{
	...
	/**
	 * Stores the audiences and roles.
	 *
	 * @return void
	 */
	public function store_audiences_roles(): void
	{    
		$saved_audiences = get_option('mailchimp_sync_import_audiences', []);
		$selected_roles = get_option('mailchimp_sync_selected_roles', []);
		echo '<pre>' . var_export($saved_audiences, true) . '</pre>';
	}
